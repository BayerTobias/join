...
function greetUser() {
  ...
  if (currentHour < 12) greetingElement.textContent = "Good morning, ";
  else if (currentHour < 18) greetingElement.textContent = "Good afternoon, ";
...
function updateUserName() {
  ...
  } else userNameElement.innerHTML = currentUser.name;
}
